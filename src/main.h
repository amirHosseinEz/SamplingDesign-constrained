...
public:
    // added for constraned mod
    string iupac_constraint; // <-- ADD THIS
    bool constrained;
    ...
    // added for constraned mod
    map<vector<int>, vector<string>> allowed_options;
    map<vector<int>, map<string, int>> options_to_idx;
    ...
    // for constraned mod
    void initialize_dist_constrained();
    void initialize_dist_no_mismatch_constrained();
